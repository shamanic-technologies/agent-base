/**
 * Network Utilities for API Gateway
 * 
 * This module provides network-related utilities for the API Gateway service,
...
export function setupNetworkDebugger(): void {
  ...
  console.log('🔧 Network debugger configured');
}
...
export function setupServerDebugger(server: any): void {
  ...
  console.log('🔧 Server debugger configured');
} 