 ...
 * AI Tools Data
 * 
 * Contains data structures for available tools organized by category
 */

import React, { ReactNode } from 'react';
import { Clock } from 'lucide-react';
import { PostgresIcon, GitHubIcon, ChromeIcon } from './icons';

// Interface for a tool
export interface Tool {
  name: string;
  description: string;
  utility: string; // Keep property name for backward compatibility
}

// Interface for a tool category
export interface ToolCategory {
  name: string;
  icon: ReactNode;
  utilities: Tool[]; // Keep property name for backward compatibility
}
