...
// // import { Plan } from '@agent-base/types';
// import Stripe from 'stripe';

// /**
//  * Get all active plans
//  */
// export async function getActivePlans(): Promise<Stripe.Product[]> {
...
//  */
// function formatPlan(product: Stripe.Product, price?: Stripe.Price):  {
//   return {
//     id: product.id,
//     name: product.name,
